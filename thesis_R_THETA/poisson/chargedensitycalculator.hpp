...
{
private:
    Quadrature<IdxRangeVrVtheta, IdxRangeRThetaVrVtheta, double> m_quadrature;
...
public:
     ...
     */
    explicit ChargeDensityCalculator(DConstFieldVrVtheta coeffs);
     ...
     */
    void operator()(DFieldRTheta rho, DConstFieldSpVrVthetaRTheta allfdistribu) const final;
};