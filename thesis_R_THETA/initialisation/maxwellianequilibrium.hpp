...
class MaxwellianEquilibrium : public IEquilibrium
{
    ...
    host_t<FieldMemSp<double>> m_density_eq;

    // equilibrium temperature of all kinetic species
    host_t<FieldMemSp<double>> m_temperature_eq;

    // equilibrium mean velocity of all kinetic species
    host_t<FieldMemSp<double>> m_mean_velocity_eq;
...
public:
     ...
     */
    DFieldSpVrVtheta operator()(DFieldSpVrVtheta allfequilibrium) const override;
